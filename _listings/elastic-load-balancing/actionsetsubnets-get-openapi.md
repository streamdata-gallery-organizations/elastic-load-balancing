...
x-complete: 0
info:
  title: Elastic Load Balancing API Enables the Availability Zone for the specified
...
paths:
  ...
  /?Action=SetSubnets:
    get:
      summary: Enables the Availability Zone for the specified subnets for the specified
        load balancer.
